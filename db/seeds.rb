...
ev1 = Event.create({title: 'App Academy Info Session', organizer_id: gabo.id, 
    date: "2021-09-24", start_time: "2021-09-24 16:00:00-05:00", end_time: "2021-09-24 17:30:00-05:00", 
...
ev2 = Event.create({title: 'Diversity In Tech Webinar', organizer_id: gabo.id, 
    date: "2021-04-00", start_time: "2021-04-00 10:00:00-05:00", end_time: "2021-04-00 12:30:00-05:00", 
...
ev3 = Event.create({title: 'Walkthrough Of A Coding Technical Interview', organizer_id: lindsey.id, 
    date: "2021-01-01", start_time: "2021-01-01 13:00:00-05:00", end_time: "2021-01-01 14:00:00-05:00", 
...
ev4 = Event.create({title: 'Virtual Career Fair In Tech', organizer_id: lindsey.id, 
    date: "2021-02-03", start_time: "2021-02-03 09:00:00-05:00", end_time: "2021-02-03 15:00:00-05:00", 
...
ev5 = Event.create({title: 'Charles Babbage: Tech & Time Travel', organizer_id: michael.id, 
    date: "2021-01-09", start_time: "2021-01-09 10:30:00-05:00", end_time: "2021-01-09 12:00:00-05:00", 
...
ev6 = Event.create({title: 'Women In Tech Panel', organizer_id: rachel.id, 
    date: "2021-03-05", start_time: "2021-03-05 10:00:00-05:00", end_time: "2021-03-05 11:30:00-05:00", 
...
ev7 = Event.create({title: 'Asgard TechWeek', organizer_id: mimi.id, 
    date: "2021-03-20", start_time: "2021-03-20 12:00:00-05:00", end_time: "2021-03-24 18:00:00-05:00", 
...
ev8 = Event.create({title: 'Why Hiring Bootcamp Grads Improves Your Business', organizer_id: demo.id, 
    date: "2021-04-04", start_time: "2021-04-04 16:00:00-05:00", end_time: "2021-04-04 17:15:00-05:00", 
...
ev9 = Event.create({title: 'NYC Digital Conference', organizer_id: demo.id, 
    date: "2021-02-08", start_time: "2021-02-08 09:00:00-05:00", end_time: "2021-02-08 2021-02-10 17:00:00-05:00", 
...
ev0 = Event.create({title: 'EST Dev Social Hour', organizer_id: rachel.id, 
    date: "2021-01-02", start_time: "2021-01-02 19:00:00[−05:00]", end_time: "2021-01-02 20:00:00[−05:00]", 
