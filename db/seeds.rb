...
ev3_promo = URI.open("https://eventech-dev.s3-us-west-1.amazonaws.com/event-seeds/techinterview.jpg")
...
ev4_promo = URI.open("https://eventech-dev.s3-us-west-1.amazonaws.com/event-seeds/careerfair.jpg")
...
ev5_promo = URI.open("https://eventech-dev.s3-us-west-1.amazonaws.com/event-seeds/typewriter.jpg")
...
ev6_promo = URI.open("https://eventech-dev.s3-us-west-1.amazonaws.com/event-seeds/womenintech.jpg")
...
ev7_promo = URI.open("https://eventech-dev.s3-us-west-1.amazonaws.com/event-seeds/guardians.jpg")
...
ev8_promo = URI.open("https://eventech-dev.s3-us-west-1.amazonaws.com/event-seeds/hireme.jpg")
...
ev9_promo = URI.open("https://eventech-dev.s3-us-west-1.amazonaws.com/event-seeds/virtualconference.jpg")
...
ev0_promo = URI.open("https://eventech-dev.s3-us-west-1.amazonaws.com/event-seeds/eastcoastsocials.jpg")
